...
var resolvers = {
   ...
   * @returns {string}
   */
  standard: function standard (type, name, formatters) {
    switch(type) {
      case 'mutations':
   ...
   */
  simple: function simple (type, name, formatters) {
    if (type === 'actions') {
      return formatters.camel('set', name) // setBar
    }
    return name // bar
...
export { store as make, Payload, get, sync, call, commit, dispatch, registerModule };
